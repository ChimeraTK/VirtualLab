...
/*******************************************************************************************************************/
void SignalSource::setCallback(
    const boost::function<double(VirtualTime)> &callback) {
...
/*******************************************************************************************************************/
void SignalSource::setOnHistoryLengthChanged(
    const boost::function<void(VirtualTime)> &callback) {
